    ...
    return (
        <>
            ...
            <div className="flex w-full justify-center gap-8 mt-10 mb-20">
                <form className="bg-white w-130 shadow-lg rounded-xl p-5 flex flex-col gap-5">
                    <h1 className="text-3xl font-semibold">Send a Message</h1>
                    <div className="flex flex-col gap-2">
                        <label className="text-lg">Name</label>
                        <input placeholder="Your name" className="bg-gray-50 border border-gray-200 rounded-lg h-12 pl-3 outline-none focus:border-blue-600"></input>
                    </div>
                    <div className="flex flex-col gap-2">
                        <label className="text-lg">Email</label>
                        <input placeholder="your.email@example.com" className="bg-gray-50 border border-gray-200 rounded-lg h-12 pl-3 outline-none focus:border-blue-600"></input>
                    </div>
                    <div className="flex flex-col gap-2">
                        <label className="text-lg">Message</label>
                        <textarea placeholder="Tell me about your project..." className="bg-gray-50 border border-gray-200 rounded-lg h-45 resize-none pl-3 pt-3 outline-none focus:border-blue-600"></textarea>
                    </div>
